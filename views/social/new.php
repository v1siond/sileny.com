<div class="default-section -edit_user -animate" data-wow-duration="1s" id="new_media">
  <div class="limited-container">
    <form class="default-form -edit" action="<?php echo route_media; ?>" data-action="new" method="POST" enctype="multipart/form-data" name="new_media">
      ...
      <input class="default-button -edit" type="submit" value="Guardar Red" name="new_media">
    </form>
  </div>
</div>