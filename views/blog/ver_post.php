    ...
    <div class="limited-container -between -post">
      <section class="posts-container">
        ...
        <div class="prev-next">
          <?php if (!empty($prev_post)): ?>
            <a class="default-link -prev" href="<?php echo route_ver_post; ?>?id=<?php echo $prev_post['id_post']; ?>">
          ...
          <?php if (!empty($next_post)): ?>
            <a class="default-link -next" href="<?php echo route_ver_post; ?>?id=<?php echo $next_post['id_post']; ?>">
      ...
      <aside class="autor-bio">
        ...
        <?php foreach ($entradas_last as $last_post): ?>
          <a class="default-link -scorpion -fullWidth" href="ver_post.php?id=<?php echo $last_post['id_post']; ?>"><?php echo $last_post['title']; ?></a>
        <?php endforeach?>
      </aside>
    </div>
  </div>
