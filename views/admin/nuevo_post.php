...
<body>
  ...
  <div class="default-section post-editor-container">
    ...
    <form class="default-form -edit -post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" name="post" enctype="multipart/form-data">
      ...
      <div class="input-container -between">
        ...
        <input type="file" name="blog_img" class="default-button -input upload-image"  required="true">
      </div>
