<div class="default-section -edit_user -animate -admin wow fadeInRight" data-wow-duration="1s" id="edit_user">
	<div class="limited-container">
		<form class="default-form -edit" action="<?php echo update_user; ?>" method="POST" enctype="multipart/form-data" name="edit_user">
